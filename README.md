...
### 🚀 Быстрая установка (Ubuntu VPS)
Для автоматической установки и настройки Xray-core (VLESS-Reality) + MyVPN выполните одну команду на вашем сервере:
```bash
bash <(curl -s https://raw.githubusercontent.com/SAquante/vpnturbo/main/install.sh)
```
Скрипт сам установит всё необходимое, сгенерирует ключи и выведет инструкции для подключения клиента!

---

### Ручная компиляция сервера и клиента
